...
export class OrganiserService {
    ...
    async createOrganiser(createOrganiserDto: CreateOrganiserDto): Promise<Organiser> {
    ...
    async updateOrganiser(id: string, updateOrganiserDto: CreateOrganiserDto): Promise<Organiser> {

...
import "./EventscannerIcon.css";
import { uploadEventImage } from "./service";

export const EventScannerIcon: React.FC = () => {
  ...
  const handleUploadAnimationClose = () => {
    if (progress === 100) {
  ...
  return (
    <div className="upload-icon-container">
      <button className="upload-icon" onClick={triggerFileInput}>
        <Upload size={28} />
      </button>
      <input
        type="file"
      ...
      <div className="upload-process">
        ...
        {showUploadAnimation && (
          <UploadAnimation
            ...
            progress={progress}
            onClose={handleUploadAnimationClose}
          />
        )}
